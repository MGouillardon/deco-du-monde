...
<template>
  <header class="navbar bg-base-100 border-b-2 border-b-base-200 px-4 md:px-6 lg:px-8 relative">
    <div class="absolute left-0 top-0 bottom-0 w-80 border-r-2 border-r-base-200 hidden lg:block"></div>
